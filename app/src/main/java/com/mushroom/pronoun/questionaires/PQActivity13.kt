...
class PQActivity13 : AppCompatActivity(), View.OnClickListener {
    var mtimes = 0
    ...
    fun loadJson() {
        ...
        try {
            val inputStream: File? =
                this.getExternalFilesDir("Pronoun/Data/m.json")  //here is where we put the json file
                    ...
                    rB1.isChecked || rB2.isChecked || rB3.isChecked || rB4.isChecked -> {
                        ...
                        when {
                            ...
                            qPosition <= arr.size -> {
                                ...
                                flag = applicationpreferences.getBoolean("flag13", false)
...
//first time
    ...
    fun update(state: Int, score: String, total: String) {
        val thread = Thread {
            ...
            databaseHelper.updateData13(state, score, total)
    ...
    fun yes(score: String, total: String) {
        val thread = Thread {
            ...
            databaseHelper.insertData13(score, total)
