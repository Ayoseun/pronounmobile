...
class PQActivity14 : AppCompatActivity(), View.OnClickListener {
    var mtimes = 0
    ...
    fun loadJson() {
        ...
        try {
            val inputStream: File? =
                this.getExternalFilesDir("Pronoun/Data/n.json")  //here is where we put the json file
                    ...
                    rB1.isChecked || rB2.isChecked || rB3.isChecked || rB4.isChecked -> {
                        ...
                        when {
                            ...
                            qPosition <= arr.size -> {
                                ...
                                flag = applicationpreferences.getBoolean("flag14", false)
...
//first time
    ...
    fun update(state: Int, score: String, total: String) {
        val thread = Thread {
            ...
            databaseHelper.updateData14(state, score, total)
    ...
    fun yes(score: String, total: String) {
        val thread = Thread {
            ...
            databaseHelper.insertData14(score, total)
