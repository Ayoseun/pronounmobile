...
object Constants {
    ...
    val spell = arrayOf(
        ...
        "COOPERATIVE MANAGEMENT", "CRIMINOLOGY AND SECURITY STUDIES",
        "DATA MANAGEMENT", "EARLY CHILDHOOD EDUCATION",
        "EDUCATION AND BIOLOGY", "EDUCATION AND CHEMISTRY",
        "EDUCATION AND ENGLISH LANGUAGE", "EDUCATION AND FRENCH",
        "EDUCATION AND INTEGRATED SCIENCE", "EDUCATION AND MATHEMATICS",
        "EDUCATION AND PHYSICS", "ENGLISH LANGUAGE", "ECONOMICS",
        "ENTREPRENEURSHIP AND BUSINESS MANAGEMENT",
        "ENVIRONMENTAL SCIENCE RESOURCES MANAGEMENT",
        "FRENCH AND INTERNATIONAL RELATIONS", "HOTEL AND CATERING MANAGEMENT",
        "HOTEL AND TOURISM MANAGEMENT", "ISLAMIC STUDIES", "LAW", "MASS COMMUNICATION",
        "MATHEMATICS", "MATHEMATICS WITH COMPUTER SCIENCE", "NURSING/NURSING SCIENCE",
        "PEACE AND DEVELOPMENT STUDIES", "PRIMARY EDUCATION STUDIES", "PUBLIC ADMINISTRATION",
        "PUBLIC HEALTH SCIENCE", "SHIPPING AND MARITIME TECHNOLOGY", "TOURISM STUDIES"
    )
